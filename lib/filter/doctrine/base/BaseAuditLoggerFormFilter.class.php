...
/**
 * AuditLogger filter form base class.
 *
 * @package    projectname
 * @subpackage filter
 ...
 */
abstract class BaseAuditLoggerFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('audit_logger_filters[%s]');
